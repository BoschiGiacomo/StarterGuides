...
\begin{enumerate}
	...
	\item The FSDA toolbox is a very active project and gets updated often, so
	      every once in a while, remember to use the \textbf{\texttt{tuna}} function to ensure
	      that you have the latest release of the toolbox installed.\par
	      To use the function, just write \textbf{\texttt{tuna}} in the command window.
...
\begin{enumerate}
	...
	\item \textbf{Do NOT buy \enquote{Data Science \emph{con} MATLAB}} as that is the
	      Italian edition.
...
\href{https://github.com/UniprJRC/DSwithMATLAB}{github.com/UniprJRC/DSwithMATLAB}. Here you
will be able to ask questions, interact with other students and the professor
through the GitHub repository \textbf{Issues} section, take part in challenges posted by the
...
\end{lstlisting}
	      ...
	      \includegraphics[width=.9\textwidth]{git clone.png}

		  If executing this command produces the error: \textbf{fatal: could not
		  create work tree dir  'DSwithMATLAB': permission denied}, it means
		  that you are trying to clone the repository into a folder where you
		  don't have writing permissions. Simply change the root folder and
	...
	\item Now you will see that a folder called \textbf{DSwithMATLAB} has been
